...
import static com.example.cmconlineproject.signup.pass;
                                    ...
                                    .addOnCompleteListener(otp.this, new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                userdetails.put("first",signup.firstname);
                                                userdetails.put("last",signup.lastname);
                                                userdetails.put("phone",signup.phonenumber);
                                                userdetails.put("DepartureDate",signup.depdate);
                                                userdetails.put("ExpectedArrival",signup.exparrdate);
        ...
        switch (view.getId()) {
            case R.id.buttonStart:
                if (!validatePhoneNumber()) {
                    Toast.makeText(otp.this, "OTP is Sent.", Toast.LENGTH_SHORT).show();
                    return;
                }
