...
public class otp2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(@NonNull String verificationId,
                ...
                mResendToken = token;
                Snackbar.make(findViewById(android.R.id.content), "OTP Sent",
                        Snackbar.LENGTH_SHORT).show();
                // [START_EXCLUDE]
                // Update UI
                                    ...
                                    .addOnCompleteListener(otp2.this, new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                userdetails.put("first",adminlogin.firstname);
                                                userdetails.put("last",adminlogin.lastname);
                                                userdetails.put("phone",adminlogin.phonenumber);
                                                userdetails.put("type",adminlogin.t);
                                                userdetails.put("unit",adminlogin.unit_str);
                                                userdetails.put("location",adminlogin.loc);
                                                userdetails.put("approved",(int)0);
        ...
        switch (view.getId()) {
            case R.id.buttonStart:
                if (!validatePhoneNumber()) {
                    Toast.makeText(otp2.this, "OTP is Sent.", Toast.LENGTH_SHORT).show();
                    return;
                }
